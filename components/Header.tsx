...
const Header = () => {
  ...
  return (
    <nav className="max-w-[1080px] w-full mx-auto bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div className={`${isOpenMenu ? 'block' : 'hidden' } justify-between items-center w-full md:flex md:w-auto md:order-1`}>
          <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
          <li>
            <a href="/challenges" className="block py-2 pr-4 pl-3 text-white bg-[#b1b845] rounded md:bg-transparent md:text-[#b1b845] md:p-0 dark:text-white" aria-current="page">Challenges</a>
          </li>
          <li>
            <a href="/solutions" className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-[#b1b845] md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Solutions</a>
          </li>
          <li>
